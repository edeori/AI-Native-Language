...
export const BUILTIN_REFERENCE_PROJECTS: ReferenceProjectAnalysis[] = [
{
  ...
  "roles": {
    "controllers": [
      ...
      "event-backend/web/src/main/java/hu/event/be/web/controller/StatsApiImpl.java",
      "event-backend/web/src/main/java/hu/event/be/web/controller/TagsApiImpl.java",
      "event-backend/web/src/main/java/hu/event/be/web/controller/TrackingApiImpl.java",
      "event-backend/web/src/main/java/hu/event/be/web/controller/UsersApiImpl.java"
    ],
    "services": [
      ...
      "event-backend/service/src/main/java/hu/event/be/service/services/PasswordResetService.java",
      "event-backend/service/src/main/java/hu/event/be/service/services/ProfileService.java",
      "event-backend/service/src/main/java/hu/event/be/service/services/RefreshTokenService.java",
      "event-backend/service/src/main/java/hu/event/be/service/services/RsvpService.java",
      "event-backend/service/src/main/java/hu/event/be/service/services/SearchService.java",
      "event-backend/service/src/main/java/hu/event/be/service/services/StatsService.java",
      "event-backend/service/src/main/java/hu/event/be/service/services/SubscriptionService.java",
      "event-backend/service/src/main/java/hu/event/be/service/services/SuperuserService.java",
      "event-backend/service/src/main/java/hu/event/be/service/services/TagFollowService.java",
      "event-backend/service/src/main/java/hu/event/be/service/services/TagService.java",
      "event-backend/service/src/main/java/hu/event/be/service/services/TrackingService.java",
      "event-backend/service/src/main/java/hu/event/be/service/services/TurnstileService.java",
      "event-backend/service/src/main/java/hu/event/be/service/services/UserService.java"
    ],
    "repositories": [
      ...
      "event-backend/persistence/src/main/java/hu/event/be/persistence/repository/SearchLogRepository.java",
      "event-backend/persistence/src/main/java/hu/event/be/persistence/repository/SearchRepository.java",
      "event-backend/persistence/src/main/java/hu/event/be/persistence/repository/StatsReadRepository.java",
      "event-backend/persistence/src/main/java/hu/event/be/persistence/repository/StatsRepository.java",
      "event-backend/persistence/src/main/java/hu/event/be/persistence/repository/TagRepository.java",
      "event-backend/persistence/src/main/java/hu/event/be/persistence/repository/TagSuggestRepository.java",
      "event-backend/persistence/src/main/java/hu/event/be/persistence/repository/TrackingRepository.java",
      "event-backend/persistence/src/main/java/hu/event/be/persistence/repository/UserFollowOrganizersRepository.java",
      "event-backend/persistence/src/main/java/hu/event/be/persistence/repository/UserOnboardingRepository.java",
      "event-backend/persistence/src/main/java/hu/event/be/persistence/repository/UserRepository.java"
    ],
    "entities": [
  ...
  "keyPaths": {
    "applicationYaml": "/Users/mothproduction/Documents/VSCode/Event-App-BE/event-backend/app/src/main/resources/application.yaml",
    "securityYaml": "/Users/mothproduction/Documents/VSCode/Event-App-BE/event-backend/app/src/main/resources/security.yaml",
    "openApiYaml": "/Users/mothproduction/Documents/VSCode/Event-App-BE/event-backend/api/src/main/resources/openapi/event-api.yaml"
  },
  "observations": [
